package fr.tangv.pickdeckcard.model.util.countdown;

import fr.tangv.pickdeckcard.model.util.Updateable;
import fr.tangv.pickdeckcard.model.util.countdown.exception.*;
...
public interface Countdown extends Updateable {
     ...
     * @param time temps qui sera ajouté au temps restant initiale
     ...
     * @param time temps qui sera retiré au temps restant initiale
     * @return le nouveau temps restant
     * @throws CountdownStoppedException si le compte à rebours est à l'arrêt
     * @throws IllegalArgumentException si le temps donné est négatif
     */
